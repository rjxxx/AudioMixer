...
namespace UsbLibrary
{
    ...
    public class SpecifiedDevice : HIDDevice
    {
        ...
        public static SpecifiedDevice FindSpecifiedDevice(int vendor_id, int product_id, string restOfPath)
        {
            return (SpecifiedDevice)FindDevice(vendor_id, product_id, restOfPath, typeof(SpecifiedDevice));
        }
        ...
        public void SendData(byte[] data)
        {
            ...
            try
            {
                ...
                DataSent?.Invoke(this, new DataSendEventArgs(oRep.Buffer));
            }
